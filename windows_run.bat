...
set "runTest=%cd%\bazel-bin\src\ovms.exe %*"
...
set "setPath=C:\opt;C:\Users\luisamur\AppData\Local\miniforge3\envs\ovms_build_env\;C:\Users\luisamur\AppData\Local\miniforge3\envs\ovms_build_env\Scripts\;C:\opt\msys64\usr\bin\;%PATH%;"
set "envPath=win_environment.log"
set PYTHONHOME=C:\Users\luisamur\AppData\Local\miniforge3\envs\ovms_build_env
